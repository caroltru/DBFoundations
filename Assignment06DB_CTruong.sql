...
-- 2023-02-18,CTruong,Created File
-- 2023-02-21,CTruong, Completed File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_CTruong')
	 Begin 
	  Alter Database [Assignment06DB_CTruong] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_CTruong;
	 End
	Create Database Assignment06DB_CTruong;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_CTruong;
...
AS
	SELECT TOP 100000	InventoryDate, ProductName, Count
...
AS
	...
	FROM dbo.Inventories as i INNER JOIN dbo.Products as p
...
AS
	SELECT TOP 100000	c.CategoryID
	, c.CategoryName
	, p.ProductID	
	, p.ProductName
	, p.UnitPrice
